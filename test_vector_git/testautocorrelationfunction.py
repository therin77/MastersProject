...
class testautocorrelationfunction(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testautocorrelationfunction")
        ...
        self.epy_block_2 = epy_block_2.blk(window=1024)
        self.epy_block_1 = epy_block_1.blk(additionFlag=True)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, 1000, 0, (3.14*.5))
...
def main(top_block_cls=testautocorrelationfunction, options=None):
